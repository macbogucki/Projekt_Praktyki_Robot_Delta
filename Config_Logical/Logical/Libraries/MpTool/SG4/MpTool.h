...
{	mcTOOL_MANAGER_DELETE_TOOLTABLE = 0,
	...
	mcTOOL_MANAGER_DELETE_PROD_LOAD
...
{	mcTOOL_MANAGER_CREATE_TOOLTABLE = 0,
	...
	mcTOOL_MANAGER_CREATE_PROD_LOAD
...
{	plcstring ToolTable[251];
	...
	plcstring ProductLoadName[251];
	struct McProductLoadType ProductLoadData;
	plcstring WireFrameName[251];
