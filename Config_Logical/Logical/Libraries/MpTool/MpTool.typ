...
TYPE
	...
	MpToolManagerParType : 	STRUCT  (*Parameters structure*)
		...
		ProductLoadName : STRING[250]; (*Name of found product load*)
		ProductLoadData : McProductLoadType; (*Data of found product load*)
	...
	McToolGetDataEnum : 
		...
		mcTOOL_GETDATA_PROD_LOAD (*Get product load parameters (.dynpartable)*)
		);
	McToolManagerDeleteModeEnum : 
		...
		mcTOOL_MANAGER_DELETE_PROD_LOAD (*Delete a product load*)
		);
	McToolManagerCreateModeEnum : 
		...
		mcTOOL_MANAGER_CREATE_PROD_LOAD (*Create a product load*)
		);
	McToolManagerGetModeEnum : 
		...
		mcTOOL_MANAGER_GET_PROD_LOAD (*Get product load data *)
		);
	McToolManagerSetModeEnum : 
		...
		mcTOOL_MANAGER_SET_PROD_LOAD (*Set product load data *)
		);
	MpToolGetDataResultType : 	STRUCT  (*Command result structure*)
		...
		DynamicsData : McToolDynamicsType; (*Data of found tool dynamics*)
		ProductLoadData : McProductLoadType; (*Data of found tool product load*)
		WireFrameData : McToolWireFrameType; (*Data of found tool wireframe*)
	END_STRUCT;
END_TYPE
